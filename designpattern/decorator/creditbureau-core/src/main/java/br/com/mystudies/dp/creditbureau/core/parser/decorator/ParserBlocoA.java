...
public class ParserBlocoA extends ParserBloco {

	
	ParserRelatorio parserRelatorio;
	

	public ParserBlocoA(ParserRelatorio parserRelatorio) {
	...
	public Relatorio parse(Protocolo protocolo, Object... objects) {
		...
		relatorio.relatorio = relatorio.relatorio + " " + protocolo.blocoA;
		return relatorio;
	}

 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://jaxws.mystudies.com.br/", wsdlLocation = "http://localhost:8080/ws/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://jaxws.mystudies.com.br/", "WebServiceService");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://jaxws.mystudies.com.br/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.mystudies.com.br/", "WebServicePort"), WebService.class, features);
    }
